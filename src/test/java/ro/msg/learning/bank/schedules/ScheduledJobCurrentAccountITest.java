...
public class ScheduledJobCurrentAccountITest {

    @SpyBean
    private ScheduledJobCurrentAccount scheduledJobCurrentAccount;
    ...
    public void test_whenWaitFiveSecond_thenScheduledIsCalledAtLeastThreeTimes() {
        ...
        await()
                ...
                .untilAsserted(() -> verify(scheduledJobCurrentAccount, atLeast(3))
                        .retainMonthlyMaintenanceCostFromCurrentAccount());
